...
describe('circle', () => {
    it('should make a circle', () => {
        ...
        shape.setColor("blue");
        expect(shape.render()).toEqual('<circle cx="25" cy="75" r="20" stroke="blue" fill="transparent" stroke-width="5"/>');
    });
});
...
describe('square', () => {
    it('should make a square', () => {
        ...
        shape.setColor("blue");
        expect(shape.render()).toEqual('<rect x="10" y="10" width="30" height="30" stroke="blue" fill="transparent" stroke-width="5"/>');
    });
});
